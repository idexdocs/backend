...
from src.main.composers.relacionamento_list_composer import relacionamento_list_composer
...
async def relacionamento(request: Request):
    try:
        ...
        http_response = await request_adapter(request, relacionamento_list_composer())
